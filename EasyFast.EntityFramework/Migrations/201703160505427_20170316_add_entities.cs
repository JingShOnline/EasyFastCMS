namespace EasyFast.Migrations
{
    ...
    public partial class _20170316_add_entities : DbMigration
    {
        public override void Up()
        {
            ...
            AddColumn("dbo.Column", "ModelId", c => c.Int());
            CreateIndex("dbo.Column", "ModelId");
            CreateIndex("dbo.Column", "Name", unique: true);
            AddForeignKey("dbo.Column", "ModelId", "dbo.Model", "Id");
        }
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Column", "ModelId", "dbo.Model");
            ...
            DropIndex("dbo.Column", new[] { "ModelId" });
            DropColumn("dbo.Column", "ModelId");
